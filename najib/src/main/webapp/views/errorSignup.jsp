...
<h1>UH-OH</h1>
<div class="hero-img">
<img src="img/ohno.png">
  <h2>Il semble que l'adresse e-mail ou le nom d'utilisateur sont déjà attribués à quelqu'un.</h2>
  <button><a href="profile.jsp"><label style="color: white; font-size: 15px">retour à la page précédente</label></button>
</div>
</div>
</section>
 <script>
    window.onload = function() {
      const images = ['img/ohno.png'];
