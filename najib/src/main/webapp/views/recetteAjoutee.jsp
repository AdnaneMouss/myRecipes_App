...
<h1 style="color: green">Votre recette a été ajoutée avec succés</h1>
<div class="hero-img">
<img src="img/burger.png">
  <h2>Nous vous remercions pour votre contribution à la réussite de l'application.</h2>
  <button><a href="myRecipes.jsp"><label style="color: white; font-size: 15px">retour à la page précédente</label></button>
</div>
</div>
</section>
 <script>
    window.onload = function() {
      const images = ['img/burger.png'];
