...
<h1 style="color: green;">Votre requête a bien été satistfaite.</h1>
<div class="hero-img">
<img src="img/good.png">
  <h2>Merci encore pour votre contribution.</h2>
  <button><a href="favoris.jsp"><label style="color: white; font-size: 15px">retour à la page précédente</label></button>
</div>
</div>
</section>
 <script>
    window.onload = function() {
      const images = ['img/good.png'];
